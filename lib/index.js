...
function (_React$Component) {
  ...
  function Carousel() {
    ...
    _this.state = _objectSpread({
      ...
      // to remove animation from the initial slide on the page load when non-default slideIndex
      // is used
    ...
    _this.setFrameRef = _this.setFrameRef.bind(_assertThisInitialized(_this));
    _this.addImageListeners = _this.addImageListeners.bind(_assertThisInitialized(_this));
  ...
  _createClass(Carousel, [{
    ...
    key: "setFrameRef",
    value: function setFrameRef(ref) {
      var _this8 = this;

      this.frame = ref; // We now have frame and can calculate slide width.
      ...
      this.setState({
        ...
        _this8.setDimensions();

        _this8.addImageListeners();
      });
    }
  }, {
    key: "addImageListeners",
    value: function addImageListeners() {
      var childNodes = this.getChildNodes();

      for (var i = 0; i < childNodes.length; i++) {
        var images = childNodes[i].getElementsByTagName('img');
